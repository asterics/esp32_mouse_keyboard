...
static uint8_t hidInfo[HID_INFORMATION_LEN] = {
    LO_UINT16(0x0111), HI_UINT16(0x0111),             // bcdHID (USB HID version)
    //TODO: setter for this country code field?!?
    0x00,                                             // bCountryCode
    HID_KBD_FLAGS                                     // Flags
};
...
/** set the bCountryCode field of the HID info.
 * @warning Set this before initializing anything else!
 * */
void hidd_set_countrycode(uint8_t countrycode)
{
    hidInfo[2] = countrycode;
}
